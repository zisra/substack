...
export function Header() {
	...
	return (
		<header className='md:sticky top-0 z-50 w-full border-b border-neutral-200 dark:border-neutral-800 p-2 dark:bg-neutral-950 bg-primary-foreground print:hidden'>
