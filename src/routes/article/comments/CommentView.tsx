				...
				<div className="flex flex-col items-center">
					...
					{!isCollapsed && (
						<div
							...
							className="relative mt-2 h-full w-px bg-input transition-50 transition-all hover:cursor-pointer hover:bg-neutral-400 dark:hover:bg-neutral-500"
						>
					...
					{!isCollapsed &&
						(body ? (
							...
							>
								...
								/>
								{!isExpanded && (
									<div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-background to-transparent pt-12 text-center">
										<button
											type="button"
