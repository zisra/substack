...
export function ArticleCard({
	...
	return (
		<Card className='mx-auto w-full max-w-lg cursor-pointer p-2 shadow-xs transition-all duration-200 hover:bg-card-hover hover:text-accent-foreground'>
...
export function Quote({
	...
	return (
		<Card className='mx-auto w-full max-w-2xl cursor-pointer px-2 py-4 shadow-xs duration-200 hover:bg-card-hover hover:text-accent-foreground'>
			<Link to={`/article/?url=${encodeURIComponent(url)}`} className='grow'>
...
export default function Comment({
	...
	return (
		<Link to={`/note/?url=${encodeURIComponent(`https://substack.com/@${handle}/note/${id}`)}`}>
			<Card className='flex cursor-pointer items-center space-x-4 p-4 shadow-xs duration-200 hover:bg-card-hover hover:text-accent-foreground'>
